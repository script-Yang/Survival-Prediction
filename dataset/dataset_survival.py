...
from utils.my_utils import generate_split, nth


class Generic_WSI_Survival_Dataset(Dataset):
    def __init__(self, csv_path = 'dataset_csv/ccrcc_clean.csv', mode = 'omic',
        ...
        slide_data = pd.read_parquet(csv_path, engine="pyarrow")
